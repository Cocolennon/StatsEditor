...
public class EditStatCommand implements TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if(args.length == 0) {
            sender.sendMessage("§3[§dStatsEditor§3]§f: §cUsage: /"+label+" <player> <stat name> <value>");
            return false;
        }
        ...
        try {
            ...
            player.sendMessage("§3[§dStatsEditor§3]§f: §cThe statistic you inputted does not exist.");
            return false;
        }
